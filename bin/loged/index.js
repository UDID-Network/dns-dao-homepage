 ...
 * @returns
 */
module.exports.PrintInfo = (...args) => console.log.call(console, '\x1b[36m%s\x1b[0m', ...args);
...
module.exports.PrintRun = (...args) =>
  console.log.call(console, '\x1b[34m🏃‍♂️🏃‍♂️🏃‍♂️🏃‍♂️🏃‍♂️🏃‍♂️\x1b[0m\n\t\x1b[36m%s\x1b[0m', ...args);
...
module.exports.PrintOK = (...args) => {
  if (args.length > 1) {
    console.log.call(console, '\x1b[32m✨✨✨✨✨✨%s\x1b[0m\n\t\x1b[36m%s\x1b[0m', ...args);
